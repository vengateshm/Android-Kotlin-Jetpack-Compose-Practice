package dev.vengateshm.compose_material3.app_widget
...
import dev.vengateshm.compose_material3.ComposeMaterial3Activity
    ...
    private fun CounterWidgetContent(count: Int) {
        Column(
            ...
            Row(
                ...
                Button(
                    text = "Open App",
                    onClick = actionStartActivity<ComposeMaterial3Activity>())
            }
        }
    }
}
