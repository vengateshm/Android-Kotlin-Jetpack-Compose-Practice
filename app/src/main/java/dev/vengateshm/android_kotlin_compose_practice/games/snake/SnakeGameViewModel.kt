...
class SnakeGameViewModel : ViewModel() {
    ...
    fun onSnakeGameEvent(snakeGameEvent: SnakeGameEvent) {
        when (snakeGameEvent) {
            ...
            is SnakeGameEvent.UpdateDirection -> {
                updateDirection(snakeGameEvent.offset, snakeGameEvent.canvasWidth)
            }
        }
    }
    ...
    private fun updateDirection(
        ...
        if (!state.value.isGameOver) {
            ...
            val head = state.value.snake.first() // Reference
    ...
    private fun updateGame(currentGame: SnakeGameState): SnakeGameState {
        ...
        val newFood =
            if (newHead == currentGame.food) {
                SnakeGameState.generateRandomFoodCoordinate()
            } else {
                currentGame.food
            }
