...
class StockEntityDaoTest {
    ...
    @Test
    fun addItem_shouldReturn_theItem_inFlow() =
        runTest {
    ...
    @Test
    fun deletedItem_shouldNot_be_present_inFlow() =
        runTest {
            val item1 = StockEntity(uid = 1, name = "Apple", symbol = "APPL")
            val item2 = StockEntity(uid = 2, name = "Microsoft", symbol = "MST")
            stockDao.addStock(item1)
    ...
    @Test
    fun updateItem_shouldReturn_theItem_inFlow() =
        runTest {
            val item1 = StockEntity(uid = 1, name = "Apple", symbol = "APPL")
            val item2 = StockEntity(uid = 2, name = "Microsoft", symbol = "MST")
    ...
    @Test
    fun search_by_query_should_return_matching_stocks() =
        runTest {
            val item1 = StockEntity(uid = 1, name = "Apple", symbol = "APPL")
            val item2 = StockEntity(uid = 2, name = "Microsoft", symbol = "MST")
